...
namespace flashgg {
    ...
    class MoreVarsDifferentialPhoIdInputsCorrector : public edm::EDProducer
    {
    public:
        MoreVarsDifferentialPhoIdInputsCorrector( const edm::ParameterSet & );
...
//        PhotonIdUtils phoTools_;
        PhotonIdUtilsMoreVars phoTools_;
    ...
    vector<string> MoreVarsDifferentialPhoIdInputsCorrector::showerShapes_ = {"r9", "s4", "sieie", "sieip", "etaWidth", "phiWidth"};
    vector<string> MoreVarsDifferentialPhoIdInputsCorrector::preshowers_ = {"esEnergyOverSCRawEnergy"};

    MoreVarsDifferentialPhoIdInputsCorrector::MoreVarsDifferentialPhoIdInputsCorrector( const edm::ParameterSet &pSet ) :
    ...
    void MoreVarsDifferentialPhoIdInputsCorrector::updatePhotonRegressions(flashgg::DiPhotonCandidate* dipho)
    {
        regress_->modifyObject(dipho->getLeadingPhoton());
        regress_->modifyObject(dipho->getSubLeadingPhoton());
    }

    void MoreVarsDifferentialPhoIdInputsCorrector::storePhotonRegressions(flashgg::DiPhotonCandidate* dipho, const std::string & label)
    {
        storeRegression(dipho->getLeadingPhoton(), label);
        storeRegression(dipho->getSubLeadingPhoton(), label);
    }

    void MoreVarsDifferentialPhoIdInputsCorrector::storeRegression(flashgg::Photon & ph, const std::string & label)
    {
    ...
    void MoreVarsDifferentialPhoIdInputsCorrector::correctPhoton( flashgg::Photon & pho, CLHEP::HepRandomEngine& engine, double rho)
    {
    ...
    void MoreVarsDifferentialPhoIdInputsCorrector::produce( edm::Event &evt, const edm::EventSetup & es)
    {
        ...
        if( ! rng.isAvailable() ) {
            throw cms::Exception( "Configuration" ) << 
                "FlashggMoreVarsDifferentialPhoIdInputsCorrector requires the RandomNumberGeneratorService  - please add to configuration";
        }
...
typedef flashgg::MoreVarsDifferentialPhoIdInputsCorrector FlashggMoreVarsDifferentialPhoIdInputsCorrector;
DEFINE_FWK_MODULE( FlashggMoreVarsDifferentialPhoIdInputsCorrector );
