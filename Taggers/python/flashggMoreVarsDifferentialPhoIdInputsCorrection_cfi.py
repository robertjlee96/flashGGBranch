...
flashggMoreVarsDifferentialPhoIdInputsCorrection = cms.EDProducer("FlashggMoreVarsDifferentialPhoIdInputsCorrector",
...
def setup_flashggMoreVarsDifferentialPhoIdInputsCorrection( process, metaConditions ):

    process.RandomNumberGeneratorService = cms.Service("RandomNumberGeneratorService",
                                                       flashggMoreVarsDifferentialPhoIdInputsCorrection=cms.PSet(
    ...
    setattr(flashggMoreVarsDifferentialPhoIdInputsCorrection, "photonIdMVAweightfile_EB", cms.FileInPath(str(metaConditions['flashggPhotons']['photonIdMVAweightfile_EB'])))
    setattr(flashggMoreVarsDifferentialPhoIdInputsCorrection, "photonIdMVAweightfile_EE", cms.FileInPath(str(metaConditions['flashggPhotons']['photonIdMVAweightfile_EE'])))
    setattr(flashggMoreVarsDifferentialPhoIdInputsCorrection, "effAreasConfigFile", cms.FileInPath(str(metaConditions['flashggPhotons']['effAreasConfigFile'])))
    setattr(flashggMoreVarsDifferentialPhoIdInputsCorrection, "is2017", cms.bool(metaConditions['flashggPhotons']['is2017']))
    corrections_summary = {}
    ...
    for var in corrections_summary['shower_shapes'].keys():
        for subdet in ['EB', 'EE']:
            ...
            setattr(flashggMoreVarsDifferentialPhoIdInputsCorrection, var+'_corrector_config_'+subdet,
                    cms.PSet(
                        variables = cms.VPSet(),
            ...
            xgb_config = getattr(flashggMoreVarsDifferentialPhoIdInputsCorrection, var+'_corrector_config_'+subdet)
    ...
    if 'preshower' in corrections_summary:
        setattr(flashggMoreVarsDifferentialPhoIdInputsCorrection, 'correctPreshower', cms.bool(True))
        for var in corrections_summary['preshower'].keys():
            preshower_summary = corrections_summary['preshower'][var]
            setattr(flashggMoreVarsDifferentialPhoIdInputsCorrection, var + '_corrector_config',
                    cms.PSet(
                        variables = cms.VPSet(),
            ...
            xgb_config = getattr(flashggMoreVarsDifferentialPhoIdInputsCorrection, var + '_corrector_config')
    ...
    for subdet in ['EB', 'EE']:
        ...
        setattr(flashggMoreVarsDifferentialPhoIdInputsCorrection, 'phoIso_corrector_config_'+subdet,
                cms.PSet(
                    clf_data = cms.PSet(
                        variables = cms.VPSet(),
        ...
        phoIso_corrector_config = getattr(flashggMoreVarsDifferentialPhoIdInputsCorrection, 'phoIso_corrector_config_'+subdet)
        ...
        setattr(flashggMoreVarsDifferentialPhoIdInputsCorrection, 'chIso_corrector_config_'+subdet,
                cms.PSet(
                    clf_data = cms.PSet(
                        variables = cms.VPSet(),
                        weights = cms.FileInPath(str(iso_summary['peak_tail_clfs']['weights_data'])),
        ...
        chIso_corrector_config = getattr(flashggMoreVarsDifferentialPhoIdInputsCorrection, 'chIso_corrector_config_'+subdet)
