#ifndef FLASHgg_PhotonIdUtilsMoreVars_h
#define FLASHgg_PhotonIdUtilsMoreVars_h
...
namespace flashgg {
    ...
    class PhotonIdUtilsMoreVars
    {

    public:

        PhotonIdUtilsMoreVars( OverlapRemovalAlgo *algo = 0 );
        ~PhotonIdUtilsMoreVars();
    ...
    private:
        ...
        float phoIdMva_rho_;
        float phoIdMva_hadTowOverEm_;
        float phoIdMva_hadronicOverEm_;
