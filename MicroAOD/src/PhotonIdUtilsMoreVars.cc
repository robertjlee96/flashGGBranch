#include "flashgg/MicroAOD/interface/PhotonIdUtilsMoreVars.h"
...
PhotonIdUtilsMoreVars::PhotonIdUtilsMoreVars( OverlapRemovalAlgo *algo) :
    overlapAlgo_( algo ), removeOverlappingCandidates_( true ), deltaPhiRotation_( 0. )
{

}

PhotonIdUtilsMoreVars::~PhotonIdUtilsMoreVars()
{
};
...
bool PhotonIdUtilsMoreVars::vetoPackedCand( const pat::Photon &photon, const edm::Ptr<pat::PackedCandidate> &pfcand )
{
...
float PhotonIdUtilsMoreVars::pfIsoChgWrtVtx( const edm::Ptr<pat::Photon> &photon,
...
map<edm::Ptr<reco::Vertex>, float> PhotonIdUtilsMoreVars::pfIsoChgWrtAllVtx( const edm::Ptr<pat::Photon> &photon,
...
float PhotonIdUtilsMoreVars::pfIsoChgWrtWorstVtx( map<edm::Ptr<reco::Vertex>, float> &vtxIsoMap )
{
...
float PhotonIdUtilsMoreVars::pfCaloIso( const edm::Ptr<pat::Photon> &photon,
...
void PhotonIdUtilsMoreVars::setupMVA( const string &xmlfilenameEB, const string &xmlfilenameEE, bool useNewPhoId, bool is2017 )
{
    ...
    phoIdMva_EB_->AddVariable( "hadTowOverEm",                  &phoIdMva_hadTowOverEm_ );
    phoIdMva_EB_->AddVariable( "hadronicOverEm",                  &phoIdMva_hadronicOverEm_ );
    ...
    phoIdMva_EE_->AddVariable( "hadTowOverEm",                  &phoIdMva_hadTowOverEm_ );
    phoIdMva_EE_->AddVariable( "hadronicOverEm",                  &phoIdMva_hadronicOverEm_ );
...
float PhotonIdUtilsMoreVars::computeMVAWrtVtx( /*edm::Ptr<flashgg::Photon>& photon,*/
    ...
    const double rho, const double eA, const std::vector<double> _phoIsoPtScalingCoeff, const double _phoIsoCutoff )
{
    ...
    phoIdMva_hadTowOverEm_    = photon.hadTowOverEm();
    phoIdMva_hadronicOverEm_  = photon.hadronicOverEm();
...
float PhotonIdUtilsMoreVars::computeCorrectPhoIso(
                                          flashgg::Photon &photon,
                                          const double rho, const double eA, const std::vector<double> _phoIsoPtScalingCoeff, const double _phoIsoCutoff )
{
    //pho iso corr in 2016 for endcap
...
map<edm::Ptr<reco::Vertex>, float> PhotonIdUtilsMoreVars::computeMVAWrtAllVtx( /*edm::Ptr<flashgg::Photon>& photon,*/
    flashgg::Photon &photon,
    const std::vector<edm::Ptr<reco::Vertex> > &vertices,
    const double rho, const double eA, const std::vector<double> _phoIsoPtScalingCoeff, const double _phoIsoCutoff )
...
flashgg::Photon PhotonIdUtilsMoreVars::pho4MomCorrection( edm::Ptr<flashgg::Photon> &photon,
...
void PhotonIdUtilsMoreVars::recomputeNonZsClusterShapes( reco::Photon &pho, noZS::EcalClusterLazyTools &tools )
{
...
void PhotonIdUtilsMoreVars::recomputeNonZsClusterShapes( reco::Photon &pho, const EcalRecHitCollection *ebRecHists, const EcalRecHitCollection *eeRecHist,
